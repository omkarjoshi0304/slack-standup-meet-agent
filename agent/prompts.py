...
done, in_progress, blockers. For each Jira issue, summarise technical work done according to linked PRs, GitHub issues and comments under Jira ticket. 
Be terse. Reference issues by key with a link, not prose.
"""
